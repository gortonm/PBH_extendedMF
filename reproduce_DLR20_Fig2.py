...
prefactor_Iso = 1e50 * (s_to_yr) / (4 * np.pi * rho_0 * (r_s_Iso**2 + r_odot**2) * (R - r_s_Iso * np.arctan(R/r_s_Iso)))
# prefactor for NFW density profile
prefactor_NFW = 1e50 * (s_to_yr) / (4 * np.pi * rho_0 * r_odot * (r_s_NFW + r_odot)**2 * (np.log(1 + (R/r_s_NFW)) - R / (R + r_s_NFW)) )
...
m_pbh_DLR20_Iso_1500pc, f_pbh_DLR20_Iso_1500pc = load_data('Dasgupta+20_Fig2_LH.csv')
...
plt.plot(m_pbh_DLR20_Iso_1500pc, f_pbh_DLR20_Iso_1500pc)
