...
fig, ax = plt.subplots(figsize=(7, 6))
ax1 = ax.twinx()
ax.plot(m_pbh_plotting/m_H, mf_NJ98(m_pbh_plotting, K=4.02*m_H, gamma=0.36, delta_c=0.4135, sigma_PS=0.11464*0.4135), color="tab:blue", label="$\sigma/\delta_c = {:.3f}$".format(0.11464))
ax.plot(m_pbh_plotting/m_H, mf_NJ98(m_pbh_plotting, K=4.02*m_H, gamma=0.36, delta_c=0.4135, sigma_PS=0.12913*0.4135), color="tab:orange", label="$\sigma/\delta_c = {:.3f}$".format(0.12913))
ax1.plot(m_pbh_plotting/m_H, mf_Yokoyama(m_pbh_plotting, m_p=Mmax_NJ(m_pbh_plotting, K=4.02*m_H, gamma=0.36, delta_c=0.4135, sigma_PS=0.11464*0.4135), gamma=0.36), color="k", linestyle="dashed", label="$\sigma/\delta_c = {:.3f}$".format(0.11464))
ax1.plot(m_pbh_plotting/m_H, mf_Yokoyama(m_pbh_plotting, m_p=Mmax_NJ(m_pbh_plotting, K=4.02*m_H, gamma=0.36, delta_c=0.4135, sigma_PS=0.12913*0.4135), gamma=0.36), color="k", linestyle="dotted", label="$\sigma/\delta_c = {:.3f}$".format(0.12913))
...
ax.hlines(0.11464, xmin=min(m_pbh_plotting), xmax=max(m_pbh_plotting), color="k", linestyle="dotted", alpha=0.4135)
ax.set_yscale("log")
ax.legend(fontsize="small")
fig.tight_layout()
