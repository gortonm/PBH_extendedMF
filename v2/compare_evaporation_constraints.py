...
ax.plot(m_KP23, fPBH_KP23, linestyle="dashed", color="purple", label="KP '23 MW diffuse (SPI)")
...
ax.legend(fontsize='small', title=r"Galactic centre photons", loc=[0.47, 0.2])
ax2.legend(fontsize='small', title=r"511 keV", loc=[0.5, 0.05])
