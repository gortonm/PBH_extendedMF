...
if "__main__" == __name__:
    ...
    print("\n Evolved MFs")
    print("Integral (M < {:.1e}g) = {:.3f} [CC3]".format(m_min_CC3, integral_lower))
    ...
    print("\n Evolved MFs")
    print("Integral (M < {:.1e}g) = {:.3f} [SLN]".format(m_min, integral_lower))
    ...
    print("\n Evolved MFs")
    print("Integral (M < {:.1e}g) = {:.3f} [LN]".format(m_min, integral_lower))
